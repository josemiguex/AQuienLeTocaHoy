...
<thead><tr><th>Orden</th><th></th><th>DNI</th><th cosplan=\"3\">Nombre y Apellidos</th><th>Pasajero</th><th>Conductor</th><th>Última fecha y hora</th><tr></thead>
<%
for (int i = 0; i < datosUsuario.length; i++) {
	...
	out.print("<tr><td>" + (i + 1) + "<td><td>" + datosUsuario[i].getDni() + "</td><td>" + datosUsuario[i].getNombre() + " " + datosUsuario[i].getApellidos() + "</td><td>" + datosUsuario[i].getPasajero() + "</td><td>" +datosUsuario[i].getConductor() + "</td><td>" + datosUsuario[i].getFecha() + " " + datosUsuario[i].getHora() + "</td></tr>");
